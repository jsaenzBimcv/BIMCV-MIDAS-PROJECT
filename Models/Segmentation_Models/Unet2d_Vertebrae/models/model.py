...
def get_unet(input_img, n_filters=16, dropout=0.5, batchnorm=True,num_classes=1, activation='sigmoid'):
    ...
    model = Model(inputs=[input_img], outputs=[outputs], name='Unet-2D')
    return model